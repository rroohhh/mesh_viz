...
enum class WaveValueType { Zero, NonZero, VALUE_TYPE_NUM_VALUES };
...
struct WaveValue {
    ...
    static constexpr auto ValueTypeBits = std::bit_width((uint32_t)WaveValueType::VALUE_TYPE_NUM_VALUES - 1);
...
namespace impl {
    ...
    struct EliasFanoWaveDatabase {
      ...
      using ReaderT  = folly::compression::EliasFanoReader<EncoderT, folly::compression::instructions::Default, true, uint32_t>;
...
using WaveDatabase = impl::BenchmarkingDatabase<impl::UncompressedWaveDatabase<true>, impl::UncompressedWaveDatabase<false>,
